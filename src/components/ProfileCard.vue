  ...
  <div class="user-main-ctn" @click="navigateProfile">
    ...
    <div class="user-bottom-ctn">
        <div class="user-bottom">
            <div v-if="profileStore.profile === undefined" class="task-title"> (NO USER)</div>
            <div class="user-data" v-else>
                <div class="user-title">{{profileStore.profile.firstName}} {{profileStore.profile.lastName}}</div>
                <div class="plan">{{profileStore.profile.plan}}</div>
            </div>
